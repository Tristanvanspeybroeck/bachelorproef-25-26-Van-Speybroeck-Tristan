...
Met de snelle evolutie van technologie en voor\-al met de opkomst van Large Language Models\linebreak(LLM's), ontstaat de mogelijkheid om automatische bewegingsfeedback toegankelijk te maken voor turntrainingen. Dit voorstel onderzoekt de haalbaarheid van een systeem dat video-opnames van de kip analyseert via pose-estimatie en deze bewegingsdata door een LLM laat interpreteren. De centrale onderzoeksvraag luidt als volgt:\linebreak
 ...
 \begin{enumerate}
     ...
     \item Waarom geven coaches onvoldoende feedback?
     \item Wat heeft een turnster nodig aan kwalitatieve feedback?
...
\begin{enumerate}
    \item Hoe accuraat zijn AI-systemen in bewegingsanalyse?
    \item Hoe betrouwbaar zijn LLMs bij sportfeedback?
    \item Waar lopen huidige systemen tegenaan?
    \item Zijn er voorbeelden die aantonen dat LLM’s bruikbare sportcoaching genereren?
\end{enumerate}
