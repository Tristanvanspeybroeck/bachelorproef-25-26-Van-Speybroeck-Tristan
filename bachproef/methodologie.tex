...
In de eerste fase word een literatuurstudie uitgevoerd rond drie kerncomponenten: (1) biomechanische kenmerken van de kip aan barre en veelvoorkomende fouten, (2) markerloze pose-estimatie in sportanalyse, en (3) automatische foutdetectie en AI-gebaseerde feedbacksystemen.
...
Daarnaast worden functionele vereisten voor het systeem opgesteld, waaronder het gebruik van standaard videobeelden en beperkte technische infrastructuur, om de toepasbaarheid binnen clubs te waarborgen.
...
Voorafgaand aan de ontwikkeling van het eigen proof-of-concept word een verkennend experiment uitgevoerd met bestaande Large Language Models (LLMs), met als doel hun huidige capaciteiten voor gymnastiekanalyse te evalueren.

In dit experiment word eenzelfde kip-oefening aangeboden aan het model in drie verschillende representaties: (1) ruwe videobeelden, (2) pose-estimatie data in CSV-formaat, en (3) een grafische voorstelling van afgeleide gewrichtshoeken. Voor elk van deze inputvormen word een gelijkaardige prompt gebruikt waarbij het model word gevraagd om de beweging te analyseren, fasen te identificeren en technische feedback te formuleren.
...
Om de output van het systeem te structureren en consistent te maken, word een gestandaardiseerd dataformaat gedefinieerd in JSON-vorm. Dit formaat bevat informatie over de geïdentificeerde bewegingsfasen, berekende gewrichtshoeken en gedetecteerde technische fouten.
